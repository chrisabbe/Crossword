// Direct JSON puzzle URL (raw GitHub link)
const puzzleURL = "https://raw.githubusercontent.com/chrisabbe/crossword/main/puzzle1.json";
...
<div class="wrap"><div class="card">
  ...
  <div class="controls">
    <button id="clearBtn" class="btn-gold">🔄 Clear My Answers</button>
  </div>
...
function buildPuzzle(data){
 ...
 const grid=data.grid,numbers=autoNumbers(grid);
 const saveKey='xwd:puzzle1',answers=JSON.parse(localStorage.getItem(saveKey)||'{}');
 gridEl.innerHTML='';
